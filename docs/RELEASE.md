...
1. You can create a normal tag: `git tag v0.3.0 -m "Release 0.3.0"`.
...
- `artifacts/omnibranch-0.3.0.tgz`
- `artifacts/omnibranch-skill-0.3.0.tar.gz`
- `artifacts/omnibranch-claude-plugin-0.3.0.tar.gz`
- `artifacts/omnibranch-0.3.0.sbom.json`
...
```sh
git tag v0.3.0 -m "OmniBranch 0.3.0"
...
5. the previously verified `artifacts/omnibranch-0.3.0.tgz`.
