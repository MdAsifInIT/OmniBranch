...
Plans:
- [ ] 03-01: Implement state machine, scheduler, ownership, leases, validation graph, and policy engine.
...
Plans:
- [ ] 06-01: Implement engine adapters, compatibility reporting, skill, scripts, and contract tests.
